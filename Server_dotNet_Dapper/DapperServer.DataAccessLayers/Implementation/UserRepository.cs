...
namespace DapperServer.DataAccessLayer.Implementation
{
    public class UserRepository : RepositoryBase, IUserRepository
    {
        ...
        {
            var query = $"SELECT * FROM UserRegistration WHERE username = '{username}'";
        ...
        {
            var query = $"SELECT id, username FROM UserRegistration WHERE username LIKE '%{username}%'";
        ...
        {
            var query = $"SELECT id, username FROM UserRegistration";
        ...
        {
            var query = $"UPDATE dbo.UserRegistration SET username = '{model.Username}' WHERE id = {id}";
        ...
        {
            var query = $"UPDATE dbo.UserRegistration SET password = '{model.Password}' WHERE id = {id}";
        ...
        {
            var query = $"UPDATE dbo.UserRegistration SET email = '{model.Email}' WHERE id = {id}";
        ...
        {
            var query = $"DELETE FROM dbo.UserRegistration WHERE id = {id}";
